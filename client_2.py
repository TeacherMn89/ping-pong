...
# --- ЗОБРАЖЕННЯ ---
ball_image = image.load("ball.jpg")
ball_image = transform.scale(ball_image, (20, 20))  # масштабування до розміру м’яча
...
while True:
    ...
    if game_state:
        ...
        screen.blit(ball_image, (ball_x - 10, ball_y - 10))  # малюємо по центру

        # Рахунок
        score_text = font_main.render(f"{game_state['scores'][0]} : {game_state['scores'][1]}", True, (255, 255, 255))
        screen.blit(score_text, (WIDTH // 2 - 25, 20))

        # Звуки (якщо будуть реалізовані)
